...
namespace SchoolDanceManageApp.Views
{
    public partial class PrivateOfficeView : Form
    {
        ...
        public PrivateOfficeView(int clientId)
        {
            ...
            button7.DataBindings.Add(new Binding(nameof(button7.Enabled), context, nameof(context.ClientHadNotTest), false, DataSourceUpdateMode.Never));
        }
        ...
        private void button1_Click(object sender, EventArgs e) // Забронировать абонемент
        {
            context.OpenBookingCommand.Execute(null);
        }

        private void button2_Click(object sender, EventArgs e) // Забронировать разовое занятие
        {
